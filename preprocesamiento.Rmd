...
TODO quitar variables inutiles
TODO discretizar la familia
TODO dummyVars
TODO quitar de las que vienen las anteriores

train$Survived <- as.factor(train$Survived)
smoteTrain <- SMOTE(Survived ~ -PassengerId -Name -Ticket -Cabin -Surname, data  = train)

TODO quitar dummyVars
```
