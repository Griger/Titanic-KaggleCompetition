...
TODO todo se va a referir a la superviviencia
TODO distribución tarifa en muertos y no muertos
TODO gráfica de distro de muertes según tam. de familia.
TOODO distro muertes según edad.
```{r distro-clases}
