...
\begin{table}[H]
\centering
\caption{Listado de soluciones}
\label{my-label}
\begin{tabular}{|c|c|c|c|c|c|}
\hline
\rowcolor[HTML]{C0C0C0} 
\textbf{Nº} & \textbf{Descripción. preprocesamiento} & \textbf{\begin{tabular}[c]{@{}c@{}}Alg. y soft. empleados\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Acierto\\ train\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Acierto\\ test\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Ranking\end{tabular}} \\ \hline
\textbf{1} & Prepro Risdal                                      &                                 &                                                                  &                                                                 &                  \\ \hline
\textbf{2} & Prepro Trevor                                      &  cfores(party)                               &                                                                  & 0.81340                                                                 & 429                \\ \hline
\textbf{3} & Prepro básico                                      & cforest(party) como en Trevor                             &                                                                  & 0.79904                                                                 &                  \\ \hline
\end{tabular}
\end{table}
\end{landscape}
